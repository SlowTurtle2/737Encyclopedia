...
export function generateStaticParams() {
  return chapters.filter(name => name !== 'Fuel' && name !== 'Anti-Ice, Rain' && name !== 'Airplane General, Emergency Equipment, Doors, Windows' && name !== 'Fire Protection' && name !== 'Landing Gear').map(name => ({ slug: slug(name) }));
}
