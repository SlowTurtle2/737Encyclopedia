  ...
  return <main id="main" className="system-course">
    ...
    <div className="wrap course-layout"><article>
      <section className="course-section" id="landing-gear">
        ...
        <Placeholder>Landing gear lever and position-indicator lights.</Placeholder>
      ...
      <section className="course-section" id="steering">
        ...
        <Placeholder>Nose-wheel steering controls and hydraulic sources.</Placeholder>
      ...
      <section className="course-section" id="brakes">
        ...
        <ul className="study-points"><li><strong>Landing arming:</strong> selecting a landing setting initiates a self-test. AUTO BRAKE DISARM illuminates if the test fails.</li><li><strong>Landing activation:</strong> both forward thrust levers at IDLE and main-wheel spin-up.</li><li><strong>After touchdown:</strong> a landing setting may be selected before decelerating through 30 kt; braking begins immediately if the activation conditions are met.</li><li><strong>Normal disarm:</strong> select OFF; the AUTO BRAKE DISARM light does not illuminate.</li><li><strong>Disarm after activation:</strong> manual braking, advancing a forward thrust lever, or moving the speed-brake lever to DOWN illuminates AUTO BRAKE DISARM.</li></ul>
