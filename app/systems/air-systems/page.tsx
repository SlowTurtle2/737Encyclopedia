  ...
  return <main id="main" className="system-course">
    ...
    <div className="wrap course-layout"><article>
      ...
      <section className="course-section" id="conditioning">
        ...
        <h3>Indications and warnings</h3>
        <div className="system-light-grid"><Light title="PACK / PACK TRIP OFF" src="/images/air-system-pack-light.png" alt="Amber PACK light">Indicates a pack overheat or loss of both primary and standby pack control. The related pack valve closes after an overheat trip.</Light><Light title="ZONE TEMP" src="/images/air-system-zone-temp-light.png" alt="Amber ZONE TEMP light">Indicates an overheat in the related zone duct or a temperature-control failure. The associated trim-air valve closes for duct overheat.</Light><Light title="EQUIP COOLING SUPPLY / EXHAUST OFF" src="/images/air-system-equipment-cooling-off-light.png" alt="Amber equipment cooling OFF light">Indicates inadequate airflow in the related supply or exhaust cooling duct. Selecting the associated fan to ALTN should start the alternate fan and extinguish the light after airflow is restored.</Light><Light title="EQUIP SMOKE · MAX" src="/images/air-system-equip-smoke-light.png" alt="Amber EQUIP SMOKE light">Illuminates with MASTER CAUTION and OVERHEAD when smoke is detected in an equipment-cooling duct.</Light></div>
