  ...
  return <main id="main" className="system-course">
    ...
    <div className="wrap course-layout"><article>
      <section className="course-section" id="schematic">
        ...
        <Figure src="/images/air-system-global-schematic.png" alt="737 NG bleed-air and air-conditioning distribution schematic" caption="NG illustration: bleed-air sources, manifold, packs, trim-air distribution and principal pneumatic users." />
      </section>
      ...
      <section className="course-section" id="bleed">
        ...
        <h3>Sources</h3>
        <ul className="study-points"><li><strong>Engines:</strong> the normal inflight source. Low-stage compressor air is sufficient during takeoff, climb and most cruise conditions. The high-stage valve modulates toward open whenever low-stage bleed air is insufficient.</li><li><strong>APU:</strong> supplies both packs on the ground or one pack in flight and provides pneumatic air for engine start.</li><li><strong>External air:</strong> connects to the right side of the manifold and can supply air conditioning or engine starting.</li></ul>
        ...
        <Figure small src="/images/air-system-bleed-panel.png" alt="737 NG bleed-air control panel" caption="NG illustration: pack, isolation-valve, engine-bleed and APU-bleed controls, with BLEED TRIP OFF indications." />
        ...
        <div className="air-system-light-list"><Light title="BLEED / BLEED TRIP OFF" src="/images/air-system-bleed-trip-off-light.png" alt="Amber BLEED TRIP OFF light"><strong>NG — BLEED TRIP OFF:</strong> indicates excessive bleed-air temperature or pressure. The related engine bleed air valve closes automatically and a reset is required.<br /><strong>MAX — BLEED:</strong> indicates excessive temperature, overpressure or a bleed-air-system fault. Illumination of both BLEED lights can also identify an incorrect configuration after takeoff or a go-around.</Light><Light title="WING-BODY OVERHEAT" src="/images/air-system-wing-body-overheat-light.png" alt="Amber WING-BODY OVERHEAT light">Indicates a bleed-duct leak in the related engine strut, inboard wing leading edge or air-conditioning bay. The left indication also monitors the keel beam and APU bleed duct.</Light><Light title="DUAL BLEED" src="/images/air-system-dual-bleed-light.png" alt="Amber DUAL BLEED light">Indicates a configuration that can allow engine bleed pressure to backpressure the APU. Engine thrust must remain at idle while the light is illuminated.</Light></div>
        ...
        <aside className="max-note"><b>EFFECTIVITY · THREE-ZONE SYSTEM</b><p><strong>NG YF501–YW164:</strong> three temperature zones, primary and standby electronic controls, PACK and ZONE TEMP lights, and two recirculation fans. <strong>MAX:</strong> the three-zone configuration is controlled by the IASC.</p></aside>
        ...
        <p>On the applicable NG three-zone system and on the MAX, three selectors set the desired temperature for the flight deck, forward cabin and aft cabin. The packs produce air cold enough for the zone demanding the most cooling; individual trim-air valves then add hot bleed air to the zone ducts as required.</p>
        ...
        <p>The applicable NG three-zone system uses two AC-powered recirculation fans. The MAX also uses two recirculation fans within its IASC-controlled three-zone configuration. They draw air from the passenger cabin and equipment bay, filter it and return it to the mix manifold, reducing pack load and engine bleed demand while maintaining cabin airflow.</p>
        ...
        <h3>Indications and warnings</h3>
        <div className="air-system-light-list"><Light title="PACK" src="/images/air-system-pack-light.png" alt="Amber PACK light"><strong>NG YF501–YW164 and MAX:</strong> indicates a pack trip off or simultaneous loss of the primary and standby pack controls.</Light><Light title="ZONE TEMP" src="/images/air-system-zone-temp-light.png" alt="Amber ZONE TEMP light"><strong>NG YF501–YW164 and MAX:</strong> indicates an overheat in the related zone duct or a temperature-control failure. The associated trim-air valve closes for duct overheat.</Light><Light title="EQUIP COOLING SUPPLY / EXHAUST OFF" src="/images/air-system-equipment-cooling-off-light.png" alt="Amber equipment cooling OFF light">Indicates inadequate airflow in the related supply or exhaust cooling duct. Selecting the associated fan to ALTN should start the alternate fan and extinguish the light after airflow is restored.</Light><Light title="EQUIP SMOKE · MAX" src="/images/air-system-equip-smoke-light.png" alt="Amber EQUIP SMOKE light">Illuminates with MASTER CAUTION and OVERHEAD when smoke is detected in an equipment-cooling duct.</Light></div>
      ...
      <section className="course-section" id="pressurization">
        ...
        <p>The overboard exhaust valve normally vents warm equipment-cooling air directly overboard on the ground and at low differential pressure. At higher inflight differential pressure it closes and directs that warm air around the forward cargo compartment. On NG YF501–YW164 and MAX aircraft, it opens when either PACK switch is set to HIGH and the right recirculation fan is off.</p>
        ...
        <div className="air-system-light-list"><Light title="AUTO FAIL" src="/images/air-system-auto-fail-light.png" alt="Amber AUTO FAIL light">Indicates loss of DC power, a controller fault, an outflow-valve control fault, or an improperly controlled excessive differential pressure, cabin rate or cabin altitude. If the other controller remains available, the system automatically transfers control to it.</Light><Light title="ALTN" src="/images/air-system-altn-light.png" alt="Green ALTN light">Indicates that the alternate automatic controller is operating. With AUTO FAIL, it confirms automatic transfer to single-channel operation.</Light><Light title="OFF SCHED DESCENT" src="/images/air-system-off-sched-descent-light.png" alt="Amber OFF SCHED DESCENT light">The aircraft has begun descending before reaching the selected cruise altitude. The controller schedules the cabin back toward takeoff-field elevation unless FLT ALT is changed.</Light><Light title="MANUAL" src="/images/air-system-manual-light.png" alt="Green MANUAL light">Illuminates green when MAN is selected and the crew directly controls outflow-valve position.</Light></div>
        <ul className="study-points"><li><strong>Cabin altitude warning:</strong> an intermittent horn sounds at approximately 10,000 ft cabin altitude.</li><li><strong>Passenger oxygen:</strong> masks deploy automatically at approximately 14,000 ft cabin altitude.</li><li><strong>Automatic failure:</strong> one failed controller transfers control to the other controller when it remains available; failure of both controllers requires MAN.</li></ul>
