  ...
  return <main id="main" className="system-course">
    ...
    <div className="wrap course-layout"><article>
      ...
      <section className="course-section" id="engine">
        ...
        <h3>Fire test</h3>
        <p><strong>FAULT/INOP test:</strong> hold the FAULT/INOP and OVHT/FIRE TEST switch at FAULT/INOP to check the engine and APU fault-monitoring circuits.</p>
        <ul className="study-points"><li>Both <strong>MASTER CAUTION</strong> lights illuminate.</li><li>The <strong>OVHT/DET</strong> system annunciator illuminates.</li><li>The amber <strong>FAULT</strong> light illuminates.</li><li>The amber <strong>APU DET INOP</strong> light illuminates.</li></ul>
        <p className="test-paragraph-spaced"><strong>OVHT/FIRE test:</strong> hold the switch at OVHT/FIRE to check the engine overheat/fire loops, APU fire loop and main-wheel-well detector.</p>
