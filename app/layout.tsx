...
return <html lang="en"><body><a className="skip" href="#main">Skip to content</a><header className="site-header"><Link className="brand" href="/"><Plane size={29} fill="currentColor" strokeWidth={1.2}/><span><b>737</b>Encyclopedia<span className="brand-dot">.</span></span></Link><nav aria-label="Main navigation"><Link href="/">Home</Link><Link href="/#systems">Systems</Link><Link href="/fmc">FMC</Link><Link href="/max-differences">MAX differences</Link><Link href="/weird-things">Weird things</Link></nav><Link className="header-cta" href="/academy">Study access <ArrowUpRight size={17}/></Link></header>{children}<footer><Link className="brand" href="/"><b>737</b>Encyclopedia.</Link><p>Independent learning resource. For study and simulation. Use current, applicable aircraft manuals and operator procedures for flight operations.</p><span>NG / MAX · Edition 01</span></footer></body></html>
}
