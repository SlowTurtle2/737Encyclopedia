...
function Navigation() {
  return <><Link href="/">Home</Link><details className="systems-menu"><summary>Systems</summary><div>{chapters.map(name => <Link key={name} href={'/systems/' + slug(name)}>{name}</Link>)}</div></details><details className="systems-menu compact-menu"><summary>Airline Assessment</summary><div><Link href="/airline-assessment/technical-interview">Technical Interview</Link><Link href="/airline-assessment/hr-interview">HR Interview</Link><Link href="/airline-assessment/simulator-session">Simulator Session</Link><Link href="/max-differences">MAX Differences</Link></div></details><details className="systems-menu compact-menu"><summary>Type Rating</summary><div><Link href="/type-rating/technical-exam">Technical Exam</Link><Link href="/type-rating/performance-exam">Performance Exam</Link><Link href="/type-rating/sop-exam">SOP Exam</Link><Link href="/fmc">FMC Tutorial</Link></div></details><details className="systems-menu compact-menu"><summary>Line Training</summary><div><Link href="/descent-management">Descent Management</Link><Link href="/line-training/refuelling-procedure">Refuelling Procedure</Link><Link href="/line-training/cpdlc">CPDLC</Link></div></details><Link href="/academy">Quiz</Link><Link href="/weird-things">Weird things</Link></>;
}
