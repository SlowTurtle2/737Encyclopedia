...
export function FmcTrainer() {
  ...
  function displayedLineValues() {
    ...
    if (page === 'POS INIT' && pageNumber === 1) { right[0] = 'N47°32.4 W122°18.6'; left[1] = extra.refAirport; right[1] = extra.gate; left[3] = '000'; right[3] = extra.irsPos; left[4] = '1432.2Z'; right[4] = 'MAR21/15'; }
    ...
    if (page === 'POS INIT' && pageNumber === 3) { left[0] = 'AUTO'; right[0] = 'NORMAL'; left[1] = '0.30/0.05'; left[2] = 'AVAILABLE'; }
