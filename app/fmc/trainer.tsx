...
type PageName = 'INDEX' | 'IDENT' | 'POS INIT' | 'RTE' | 'LEGS' | 'PERF INIT' | 'PROGRESS' | 'DEP ARR' | 'TAKEOFF REF' | 'FIX INFO';
...
export function FmcTrainer() {
  ...
  if (page === 'TAKEOFF REF') leftActions[5] = () => setPage('INDEX');
  if (page === 'FIX INFO') leftActions[0] = () => setMessage('ENTER FIX IDENT');
  ...
  function ScreenContent() {
    ...
    if (page === 'TAKEOFF REF') return <><Pair leftLabel="OAT" left="+20°C  +68°F" rightLabel="V1" right="134KT"/><Pair leftLabel="SEL TEMP" left="+38°C +100°F" rightLabel="VR" right="134KT"/><Pair leftLabel="RED 20K N1" left="90.5/89.6%" rightLabel="V2" right="141KT"/><Pair left="---PRE-FLT COMPLETE---"/><Pair rightLabel="TO SHIFT" right="RW27  -00M"/><Pair left="<INDEX"/></>;
    if (page === 'FIX INFO') return <><Pair leftLabel="FIX" left="□□□□□" rightLabel="RAD/DIS FR" right=""/><Pair leftLabel="RAD/DIS" left="---" rightLabel="ETA / DTG / ALT" right=""/><Pair left="---"/><Pair left="---"/><Pair leftLabel="ABEAM" left="236/41" right="2000.9  27 FL350"/><Pair/></>;
