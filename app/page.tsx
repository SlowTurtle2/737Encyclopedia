      ...
      <section className="wrap section" id="systems">
        <div className="section-heading">
          ...
          <span className="library-count">
            15 systems <span> / 8 available</span>
          </span>
        </div>
        <div className="system-shortcuts">
          {chapters.map((name, index) => {
            const Icon = icons[index];
            const available = name === 'Fuel' || name === 'Air Systems' || name === 'Anti-Ice, Rain' || name === 'Airplane General, Emergency Equipment, Doors, Windows' || name === 'Fire Protection' || name === 'Landing Gear' || name === 'Engines, APU' || name === 'Hydraulics';
            return (
              <Link
                key={name}
