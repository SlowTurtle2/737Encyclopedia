        ...
        <article>
          ...
          <section className="course-section" id="atpl-basics">
            ...
            <ul className="study-points q-list">
              ...
              <li>What is TUC at 40,000 ft?<span className="q-hint">Time of useful consciousness ~15–20 seconds.</span></li>
            ...
            <ul className="study-points q-list">
              ...
              <li><Hot />What is the difference between the GPWS and the EGPWS? Explain the EGPWS.<span className="q-hint">GPWS is reactive (radio alt, modes 1–7); EGPWS adds a terrain database + GPS for predictive look-ahead and a terrain display.</span></li>
              <li>You get a TCAS RA to climb at your service ceiling — what do you do?<span className="q-hint">Follow the RA with the performance available — may not achieve the full rate.</span></li>
