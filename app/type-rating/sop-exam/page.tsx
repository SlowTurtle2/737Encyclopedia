...
import { sopQuestions } from './questions';
    ...
    <main id="main" className="system-course">
      <div className="wrap fuel-course-banner">
        ...
        <div className="course-meta">
          ...
          <span className="pill">{sopQuestions.length} QUESTIONS</span>
        </div>
      </div>
      <div className="wrap course-layout">
        <article>
          <section className="course-section">
            ...
            <p>
              Pick an answer and the correct one is revealed straight away. The
              questions are drawn in a random order each time, so run it as many
              times as you like. Always defer to your operator&rsquo;s current
              SOPs and manuals; this is study material only.
            </p>
            <Quiz />
          </section>
